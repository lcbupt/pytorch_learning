import os
from tqdm import tqdm   # 迭代器显示进度条的包
import h5py     # h5数据集存放文件
import numpy as np
import argparse
...
root = '/home/xiaozhi/Documents/PycharmProjects/pytorch learning/learn byself/kaggle-dogs-vs-cats/data'
data_folder = {
