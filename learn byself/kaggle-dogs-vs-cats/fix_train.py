...
# define image transforms to do data argumentation
data_transforms = {
    'train':
    transforms.Compose([
...
root = '/home/xiaozhi/Documents/PycharmProjects/pytorch learning/learn byself/kaggle-dogs-vs-cats/'
data_folder = {
    'train':
    ImageFolder(
...
dim_in = transfer_model.fc.in_features*16   # ???????? 我改了乘以16，否则矩阵相乘维度错误
